package com.apixandru.casestudy.app4;
 ...
 * @since Oct 16, 2016
 */
@SpringBootApplication(scanBasePackages = "com.apixandru.casestudy.app4")
public class ChangedJobNameApplication extends BaseSchedulerApplication {
